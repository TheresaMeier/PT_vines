...
We draw $n\in\{200,500,1000,2000,5000\}$ observations from the Clayton, Gumbel, and Student ($\nu=4$) copulas at Kendall's $\tau\in\{0.4,0.8\}$, with $30$ replications each; both $\hat c_B$ and $\hat c_T$ use the probit-transform local-likelihood estimator of \citet{geenens2017probit} with the constant, maximal-correlation bandwidth.
