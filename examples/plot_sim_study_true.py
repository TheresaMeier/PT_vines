...
FAMILY_ORDER: tuple[str, ...] = ("Clayton", "Gumbel", "Student", "Tawn")
...
def main() -> None:
  ...
  parser.add_argument(
    "--output",
    type=Path,
    default=Path("latex/figures/sim_study_true_tawn.png"),
  )
